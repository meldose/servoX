...
def servo_j(): # defining function for servoJ
    ...
    inp.max_velocity = [4]*dof # setting up the maximum velocity 
    ...
    inp.max_velocity = [4]*dof # defining the maximum velocity
    inp.max_acceleration = [6]*dof # defining the maximum acceleration
    inp.max_jerk = [10.]*dof
